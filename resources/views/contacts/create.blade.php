...
<div class="p-3">
  ...
  <form action="{{ route('contacts.store') }}" method="POST">
    ...
    <div class="mb-3">
      ...
      <input name="email" type="email" class="form-control" id="email" placeholder="contact@isep.sn">
    </div>
    <div class="mb-3">
      <label for="iban" class="form-label">Iban</label>
      <input name="iban" type="text" class="form-control" id="iban" placeholder="Ex AC45 1234 1234 1234">
    </div>
